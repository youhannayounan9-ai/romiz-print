...
const CategoryBarChart = dynamic(() => import("./AdminCharts").then((m) => m.CategoryBarChart), { ssr: false });
const TimeLineChart = dynamic(() => import("./AdminCharts").then((m) => m.TimeLineChart), { ssr: false });
import {
  FileText,
  TrendingUp,
  Hash,
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          ...
          <TimeLineChart timeData={timeData} />
        </div>
      </div>
